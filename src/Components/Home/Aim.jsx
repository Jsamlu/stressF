  ...
  return (
    <div className=" px-2 md:px-4 py-10 ">
      <div className="md:ml-[10%] md:w-[60%] mx-auto  md:pt-4 pb-4 rounded-xl flex flex-col gap-y-5">
        ...
        <div className=" md:text-2xl sm:text-lg font-serif text-sm pt-1 pb-4 text-center text-wrap text-gray-700">
          <p className="sm:leading-10">
            ...
            and personal life.</p>
            <br /> 
            <p className="sm:leading-10">That’s why we’re here! D-Stress is your go-to
