...
function Hero() {
  return (
    <>
      ...
      <S_header></S_header>
      <div className="p-8 pt-[200px] absolute top-0 w-screen h-screen items-center backdrop-blur-sm max-w-full">
        
        <div className='z-10'>
          
          <div className='text-balck pl-7'> 
            <h2 className="lg:text-7xl  lg:font-semibold text-3xl font-bold text-left text-white ds">Find peace in the present moment;<br/>it’s where stress fades away.</h2>
            <p className='lg:mt-4 lg:text-2xl text-xl text-left text-white ds'>Gain an understanding of stress, its causes, and effective strategies to manage it.</p>
