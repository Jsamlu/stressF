        ...
        <div className=''>
          ...
          <div className='text-balck pl-7'> 
            ...
            <div className='mx-10 my-20 flex items-center justify-start gap-10 '>
              <Link to="/test" className='text-white md:text-5xl text-2xl font-semibold md:px-6 md:py-5 px-3 py-2 shadow-lg shadow-gray-500 bg-teal-500 hover:bg-teal-700 rounded-full'>Get Started</Link>
