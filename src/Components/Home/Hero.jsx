      ...
      <div className="p-8 pt-[150px] absolute top-0 w-screen h-screen items-center backdrop-blur-sm">
        ...
        <div className='align-middle'>
          ...
          <div className='text-balck pl-7'> 
            <h2 className="lg:text-7xl  lg:font-bold text-3xl font-bold text-left text-white font-outline-1">Stress is like a Bubble if not pop it only grows Bigger</h2>
