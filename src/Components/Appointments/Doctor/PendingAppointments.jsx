      ...
      <div>
        {PendingApplist.map((ap) => {
          return (
            <div
              id="pending"
              className="w-[75%] my-1  text-sky-900 hover:text-white transition-all duration-200 hover:bg-gradient-to-br from-sky-500 to-green-500 bg-white h-[60px] rounded-xl flex justify-between items-center py-2 px-5 hover:scale-105"
            >
              <div>
