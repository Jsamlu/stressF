      ...
      <div>
        {PendingApplist.map((ap) => {
          return (
            <div
              id="pending"
              className="w-[75%] my-1  text-sky-900  transition-all duration-200 bg-white h-[60px] rounded-xl flex justify-between items-center py-2 px-5 hover:scale-[.92] scale-90"
            >
              <div>
