              ...
              return (
                  <div className="h-[500px] w-[300px] bg-white rounded-xl grid grid-rows-3 shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out">
                    <div className="rounded-tr-xl rounded-tl-xl overflow-hidden row-span-2 h-[300px]">
                      <img src={ACT.image} alt="" className="transform hover:scale-[110%] transition-all duration-300"/>
                    </div>
                    <div className="mx-auto">
                      <p className="font-bold text-lg">
                        {ACT.name}
                      </p>
                      <p className="mt-2 mb-3 txt">
                        {ACT.desc}
                      </p>
                      ...
                      <button  className="text-white text-center bg-blue-400 rounded-lg px-1 py-1 hover:bg-white   hover:font-bold hover:text-blue-800 border-2 border-white hover:boder-2 hover:border-blue-900 transition-all duration-400">Add</button>
                      </div>
                    </div>
                  </div>
                );
